                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('brand.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row mb-4">
                                        <label for="horizontal-category-name-input" class="col-sm-2 col-form-label">Brand
                                            name</label>
                                        <div class="col-sm-10">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h1 class="card-title pb-1">All Brands informations</h1>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img style="height: 80px;witdh:'100px'"
                                                        src="{{ asset('/') . $brand->image }}" class="img-fluid"
                                                        alt="" srcset="">
                                                </td>
                                                ...
                                                <td>
                                                    <a href="{{ route('brand.status.update', ['brand' => $brand->id]) }}"
                                                        class="btn btn-primary btn-sm {{ $brand->status === 1 ? 'bg-success' : 'bg-danger' }}">
