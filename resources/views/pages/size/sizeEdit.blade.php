            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title mb-4">Update size</h4>
                                <hr>
                                @if (session('message'))
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="name"
                                                id="horizontal-category-name-input" value="{{ $size->name }}">
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
                                        <label for="horizontal-category-name-input" class="col-sm-2 col-form-label">size
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="code"
                                                id="horizontal-category-name-input" value="{{ $size->code }}">
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea name="description" id="horizontal-description-input" cols="30"
                                                ...
                                                rows="5">{{ $size->description }}</textarea>
