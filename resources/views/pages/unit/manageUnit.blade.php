            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title mb-4">Create New unit</h4>
                                <hr>
                                @if (session('message'))
                                ...
                                <form action="{{ route('unit.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row mb-4">
                                        <label for="horizontal-category-name-input" class="col-sm-2 col-form-label">unit
                                            name</label>
                                        <div class="col-sm-10">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h1 class="card-title pb-1">All unit informations</h1>
                                    ...
                                    <tbody>
                                        @foreach ($units as $unit)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('unit.status.update', ['unit' => $unit->id]) }}"
                                                        class="btn btn-primary btn-sm {{ $unit->status === 1 ? 'bg-success' : 'bg-danger' }}">
                                                    ...
                                                    <form class="d-inline-block" action="{{ route('unit.destroy', $unit->id) }}"
                                                        method="post">
                                                        @csrf
                                                        @method('DELETE')
